package com.costa.bookstore.domain;
...
public class Livro implements Serializable{
	...
	@Length(min = 4, max = 50, message = "Deve ter entre 4 e 50 caracteres!")
	...
	@Length(min = 10, max = 2000, message = "Deve ter entre 10 e 2000 caracteres!")
